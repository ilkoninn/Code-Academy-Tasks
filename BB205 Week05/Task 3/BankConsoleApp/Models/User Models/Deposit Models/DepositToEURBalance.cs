...
namespace BankConsoleApp.Models.User_Models.Deposit_Models
{
    internal static class DepositToEURBalance
    {
        public static void Deposit(User user, BankCard bankCard, CurrencyType currencyType)
        {
            switch (currencyType)
            {
                ...
                PATH22:
                    ...
                    {
                        DepositToEURBankCard(user, bankCard, newAmount * (decimal)0.56, currencyType);
                    }
                    else
                    {
                ...
                PATH23:
                    ...
                    {
                        DepositToEURBankCard(user, bankCard, newAmount2 * (decimal)0.94, currencyType);
                    }
                    else
                    {
                        Console.WriteLine("The amount of money should be decimal type!");
                ...
                PATH24:
                    ...
                    {
                        DepositToEURBankCard(user, bankCard, newAmount3, currencyType);
                    }
                    else
                    {
                        Console.WriteLine("The amount of money should be decimal type!");
        ...
        public static void DepositToEURBankCard(User user, BankCard bankCard, decimal amount, CurrencyType currencyType)
        {
            string result;
            ...
            newUser.bankCards.Find(u => u.AccountId == bankCard.AccountId).DepositEUR(amount);
            if (amount > 0)
            {
